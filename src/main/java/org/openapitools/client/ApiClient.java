...
public class ApiClient {
    ...
    private String basePath = "https://api.loginradius.com/v2/manage";
    ...
    public ApiClient() {
        ...
        authentications.put("ApiSecretAuth", new ApiKeyAuth("query", "apisecret"));
        authentications.put("ClientIdAuth", new ApiKeyAuth("query", "clientID"));
        authentications.put("ClientSecretAuth", new ApiKeyAuth("query", "clientSecret"));
        authentications.put("M2MBearerAuth", new HttpBearerAuth("bearer"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.loginradius.com/v2/manage
